...
class TestNetworkTrainer(unittest.TestCase):
    def test_loss_decreases(self):
        ...
        cost_prev, delta_w, delta_b = trainer.backpropagation(network, x, y, nwt.NetworkTrainer.quadratic)
        for _ in range(10):
            ...
            cost_new, delta_w, delta_b = trainer.backpropagation(network, x, y, nwt.NetworkTrainer.quadratic)
